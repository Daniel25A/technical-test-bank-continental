        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Symbol = table.Column<string>(type: "varchar(2)", maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    FoundInAccount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankId = table.Column<long>(type: "bigint", nullable: false),
                    FDateTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountMovements_Banks_BankId",
                        column: x => x.BankId,
                        principalTable: "Banks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountMovements_UserAccounts_UserAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountMovements_BankId",
                table: "AccountMovements",
                column: "BankId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountMovements_UserAccountId",
                table: "AccountMovements",
